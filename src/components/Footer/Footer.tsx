  ...
  return (
    <>
      ...
      >
        ...
        <Image.Avatar 
          src="/avatar.png"
          alt={`Profile picture of ${footerData.name}`}
          size="lg"
        ...
        <ContactInfo>
          {footerData.name && (
            <ContactName>{footerData.name}</ContactName>
          )}
      ...
      <FooterMarquee aria-hidden="true">
        <MarqueeText>
          Daniel Lauding • Fullstack Developer • Daniel Lauding • Fullstack Developer • 
        </MarqueeText>
      </FooterMarquee>
    </>
  )
